...
public class SporeBlossomBlockMixin extends Block {
    public SporeBlossomBlockMixin(AbstractBlock.Settings settings) {
        super(settings);
    }

    public boolean fertilizable$isFertilizable(BlockView world, BlockPos pos, BlockState state, boolean isClient) {
        return CompleteBoneMealMod.CONFIG == null || CompleteBoneMealMod.CONFIG.enableSporeBlossomsBoneMeal;
    }
